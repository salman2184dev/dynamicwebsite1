...
function validationCheckAddOrEdit() {
    ...
    if (CName == "") {
        toastr.error("Company Name  can't be Empty.");
        return false;
    }
    var CEmail = $('#CEmail').val().trim();
    if (CEmail == "") {
        toastr.error("Company Email  can't be Empty.");
        return false;
    }
  
    var CAddress = $('#CAddress').val().trim();
    if (CAddress == "") {
        toastr.error("Company Address  can't be Empty.");
        return false;
    }

    var cimage = $('#cimage').val();
    var image = $('#modelCompanyImage').val();
    if (image == cimage) {
