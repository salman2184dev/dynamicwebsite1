...
$(function () {
    ...
    ChatHubProxy.client.updateChat = function (userName, message, isPm) {
        var $newMessage;
    ...
    ChatHubProxy.client.updateUsersOnline = function (data) {
        if (!data.Success) {
    ...
    $.connection.hub.start()
        .done(function () {
            var status = ChatHubProxy.server.connectUser(currentUserName).done(function (data, textStatus, jqXHR) {
                if (!data.Success) {
                    alert(data.ErrorMessage);
                    return;
                }
                ...
                var sendMessage = function () {
                    ...
                    ChatHubProxy.server.sendMessage(currentUserName, $message.val());
                    $message.val('');
                };
